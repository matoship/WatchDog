...
def run(estimation_model: str, tracker_type: str, classification_model: str,
  ...
  # print(f"Default Frame Width: {default_width}, Default Frame Height: {default_height}")
  """
  cap.set(cv2.CAP_PROP_FRAME_WIDTH, width)
  cap.set(cv2.CAP_PROP_FRAME_HEIGHT, height)
  
  """
  # Retrieve the actual frame width and height
  actual_width = int(cap.get(cv2.CAP_PROP_FRAME_WIDTH))
  actual_height = int(cap.get(cv2.CAP_PROP_FRAME_HEIGHT))
  print(f"Frame Width: {actual_width}, Frame Height: {actual_height}")
  """
